...
if st.button('Recommend'):
    ...
    for t in range(0,5):
        ...
        with tab[t]:
            ...
            st.write(f'<b style="color:red">Rating:</b> <b style="color:yellow">{recommend_movies_release[t]}</b>',
                      unsafe_allow_html=True)
            st.write(f'<b style="color:red">Genre:</b> <b style="color:yellow">{recommend_movies_Director[t]} <b> ',
                      unsafe_allow_html=True)
            st.write(f'<b style="color:red">Rating:</b> <b style="color:yellow">{recommend_movies_Stars[t]}</b>',
                      unsafe_allow_html=True)
